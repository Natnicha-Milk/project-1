            ...
            <nav class="navbar bg-light ">
                <div class="container">
                    ...
                    <a href="/"
                        ...
                        <img src="{{ asset('image/logo-wed2.png') }}" height="90" />
                    </a>
                            ...
                            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3" id="menu"
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('user-home') }}" class="nav-link align-middle px-0">
                                        ...
                                        <span class="ms-1" style="color: #000000;">เหตุการณ์ทั้งหมด</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('form-user') }}" class="nav-link align-middle px-0">
                                        <i class="fs-4 bi bi-clipboard2-plus" style="color: #000000;"></i>
                                        <span class="ms-1" style="color: #000000;">บันทึกเหตุการณ์</span>
                                    </a>
                                </li>
                                <li class="nav-item">
